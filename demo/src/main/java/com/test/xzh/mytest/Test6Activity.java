        ...
        x.http().get(requestParams, new Callback.CommonCallback<File>() {
            ...
            public void onSuccess(File result) {
                ...
                if(result == null) {
                    ...
                    Toast.makeText(Test6Activity.this, "图片格式错误", Toast.LENGTH_SHORT).show();

                }else {

                    //result = "http://weixin.qq.com/d";
                    Toast.makeText(Test6Activity.this, result.toString() + "", Toast.LENGTH_SHORT).show();
                }
            }
